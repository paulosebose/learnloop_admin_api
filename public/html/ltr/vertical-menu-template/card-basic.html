        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather="credit-card"></i><span class="menu-title text-truncate" data-i18n="Card">Card</span><span class="badge badge-light-success badge-pill ml-auto mr-1">New</span></a>
                    <ul class="menu-content">
                        <li class="active"><a class="d-flex align-items-center" href="card-basic.html"><i data-feather="circle"></i><span class="menu-item" data-i18n="Basic">Basic</span></a>
                        </li>
            ...
            <div class="content-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-xl-4">
                            <div class="card mb-3">
                                ...
                                <img class="card-img-bottom" src="../../../app-assets/images/slider/09.jpg" alt="Card image cap" />
                            </div>
                        </div>
                        <div class="col-md-6 col-xl-4">
                ...
                <section class="card-layout">
                    ...
                    <div class="card-columns">
                        ...
                        <div class="card position-static">
                            <img class="card-img" src="../../../app-assets/images/slider/02.jpg" alt="Card image" />
                        </div>
