            ...
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather="box"></i><span class="menu-title text-truncate" data-i18n="Extensions">Extensions</span></a>
                    <ul class="menu-content">
                        ...
                        <li class="active"><a class="d-flex align-items-center" href="ext-component-swiper.html"><i data-feather="circle"></i><span class="menu-item" data-i18n="swiper">Swiper</span></a>
                        </li>
                        ...
                        <div class="card-body">
                            <div class="swiper-navigations swiper-container">
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <img class="img-fluid" src="../../../app-assets/images/banner/banner-14.jpg" alt="banner" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-fluid" src="../../../app-assets/images/banner/banner-3.jpg" alt="banner" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-fluid" src="../../../app-assets/images/banner/banner-2.jpg" alt="banner" />
                                    </div>
                        ...
                        <div class="card-body">
                            <div class="swiper-progress swiper-container">
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <img class="img-fluid" src="../../../app-assets/images/banner/banner-5.jpg" alt="banner" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-fluid" src="../../../app-assets/images/banner/banner-4.jpg" alt="banner" />
                                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="swiper-multi-row swiper-container">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img class="img-fluid" src="../../../app-assets/images/banner/banner-26.jpg" alt="banner" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-fluid" src="../../../app-assets/images/banner/banner-39.jpg" alt="banner" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-fluid" src="../../../app-assets/images/banner/banner-28.jpg" alt="banner" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-fluid" src="../../../app-assets/images/banner/banner-29.jpg" alt="banner" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-fluid" src="../../../app-assets/images/banner/banner-30.jpg" alt="banner" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-fluid" src="../../../app-assets/images/banner/banner-31.jpg" alt="banner" />
                                    </div>
                        ...
                        <div class="card-body">
                            <div class="swiper-fade-effect swiper-container">
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <img class="img-fluid" src="../../../app-assets/images/banner/banner-19.jpg" alt="banner" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-fluid" src="../../../app-assets/images/banner/banner-18.jpg" alt="banner" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-fluid" src="../../../app-assets/images/banner/banner-17.jpg" alt="banner" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-fluid" src="../../../app-assets/images/banner/banner-16.jpg" alt="banner" />
                                    </div>
                                </div>
                                <!-- Add Pagination -->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="swiper-cube-effect swiper-container">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img class="img-fluid" src="../../../app-assets/images/banner/banner-21.jpg" alt="banner" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-fluid" src="../../../app-assets/images/banner/banner-22.jpg" alt="banner" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-fluid" src="../../../app-assets/images/banner/banner-23.jpg" alt="banner" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-fluid" src="../../../app-assets/images/banner/banner-24.jpg" alt="banner" />
                                    </div>
                                </div>
                                <!-- Add Pagination -->
                                <div class="swiper-pagination swiper-pagination-white"></div>
                        ...
                        <div class="card-body">
                            <div class="swiper-autoplay swiper-container">
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <img class="img-fluid" src="../../../app-assets/images/banner/banner-10.jpg" alt="banner" />
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-fluid" src="../../../app-assets/images/banner/banner-11.jpg" alt="banner" />
                                    </div>
                                </div>
                                <!-- Add Pagination -->
                                <div class="swiper-pagination"></div>
                        ...
                        <div class="card-body">
                            <div class="swiper-gallery swiper-container gallery-top">
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <img class="img-fluid" src="../../../app-assets/images/banner/banner-15.jpg" alt="banner" />
                                    </div>
                                </div>
                                <!-- Add Arrows -->
                                <div class="swiper-button-next"></div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="swiper-parallax swiper-container">
                                <div class="parallax-bg" data-swiper-parallax="-23%">
                                    <img class="img-fluid" src="../../../app-assets/images/banner/parallax-4.jpg" alt="banner" />
                                </div>
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
