            ...
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather="briefcase"></i><span class="menu-title text-truncate" data-i18n="Components">Components</span></a>
                    <ul class="menu-content">
                        ...
                        <li class="active"><a class="d-flex align-items-center" href="component-bs-toast.html"><i data-feather="circle"></i><span class="menu-item" data-i18n="Toasts">Toasts</span></a>
                        </li>
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-body bg-primary rounded-bottom">
                                    <div class="toast show toast-wrapper toast-translucent mt-1" role="alert" aria-live="assertive" aria-atomic="true">
