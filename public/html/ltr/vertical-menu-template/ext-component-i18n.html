...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="">
            ...
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather="box"></i><span class="menu-title text-truncate" data-i18n="Extensions">Extensions</span></a>
                    <ul class="menu-content">
                        ...
                        <li class="active"><a class="d-flex align-items-center" href="ext-component-i18n.html"><i data-feather="circle"></i><span class="menu-item" data-i18n="l18n">l18n</span></a>
                        </li>
                    </ul>
                </li>
                                ...
                                <div class="card-body">
                                    <div class="language-options checkbox">
                                        <div class="custom-control custom-radio mb-50">
                                            <input type="radio" id="i18n-lang-radio1" name="i18n-lang-radios" class="custom-control-input i18n-lang-option" data-lng="en_p" checked />
                                        ...
                                        <div class="custom-control custom-radio mb-50">
                                            <input type="radio" id="i18n-lang-radio4" name="i18n-lang-radios" class="custom-control-input i18n-lang-option" data-lng="pt_p" />
    ...
    <!-- BEGIN: Page JS-->
    <script src="../../../app-assets/js/scripts/extensions/ext-component-i18n.js"></script>
    <!-- END: Page JS-->
