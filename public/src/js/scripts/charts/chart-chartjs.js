...
$(window).on('load', function () {
  ...
  var primaryColorShade = '#836AF9',
    ...
    tooltipShadow = '#1B247E(0, 0, 0, 0.25)',
    lineChartPrimary = '#666ee8',
    lineChartDanger = '#ff4961',
    labelColor = '#6e6b7b',
    grid_line_color = '#1B247E(200, 200, 200, 0.2)'; // #1B247E color helps in dark layout
  ...
  if (radarChartEx.length) {
    ...
    gradientBlue.addColorStop(0, '#1B247E(155,136,250, 0.9)');
    gradientBlue.addColorStop(1, '#1B247E(155,136,250, 0.8)');

    var gradientRed = canvas.getContext('2d').createLinearGradient(0, 0, 0, 150);
    gradientRed.addColorStop(0, '#1B247E(255,161,161, 0.9)');
    gradientRed.addColorStop(1, '#1B247E(255,161,161, 0.8)');
