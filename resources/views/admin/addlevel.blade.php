        ...
        <div class="content-wrapper">
            ...
            <div class="content-body">
                ...
                <section id="dashboard-analytics">
                    ...
                    <!-- List DataTable -->
                    <div class="container">
                        <h2 class="text-center mt-4">Add Level</h2>
                        @if(session('success'))
                        ...
                        @endif
                            ...
                            @endif
                            <form action="{{ route('insertlevel') }}" method="POST" enctype="multipart/form-data">  <!-- Update with your route -->
                            @csrf
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <!-- Checkbox for the 'paid' field. It will send 'on' if checked, or nothing if unchecked -->
