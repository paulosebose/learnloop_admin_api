...
<head>
    ...
    <!-- BEGIN: Custom CSS-->
    <link rel="stylesheet" type="text/css" href="/spartans/quizsite/public/assets/css/style.css">
    <!-- END: Custom CSS-->
        ...
        <div class="content-wrapper">
            ...
            <div class="content-body">
                ...
                <section id="dashboard-analytics">
                    ...
                    <!-- List DataTable -->
                    <div class="container">
                        <h2 class="text-center mt-4">Edit Exam</h2>
                        @if(session('success'))
                    ...
                    @endif
                        ...
                        <div class="table-responsive">
                            <form action="{{ route('updateexam', ['id' => $exam->id]) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <input type="hidden" name="level_id" value="{{ $exam->level_id }}">
                                <div class="form-group">
                                    <label for="exam_name">Exam Name</label>
                                    <input type="text" name="exam_name" id="exam_name" class="form-control" value="{{ $exam->exam_name }}" required>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    @if($level->image)
                                        <div class="mt-2">
                                            <p>Current Image:</p>
                                            <img src="{{ asset($exam->image) }}" alt="Level Image" class="img-thumbnail" width="100">
                                        </div>
                                    @endif
                                </div>
                                ...
                                <a href="{{ route('examview', ['id' => $level->id]) }}" class="btn btn-secondary mt-3">Back</a>
