        ...
        <div class="content-wrapper">
            ...
            <div class="content-body">
                <section id="dashboard-analytics">
                    <div class="container">
                        <h2 class="text-center mt-4">Add Subadmin</h2>
                        ...
                        <form action="{{ route('add.subadmin') }}" method="POST">
                            ...
                            <div class="form-group">
                                <label for="show_password">
                                    <input type="checkbox" id="show_password" onclick="togglePassword('password')"> Show Password
                                </label>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="show_password_confirmation">
                                    <input type="checkbox" id="show_password_confirmation" onclick="togglePassword('password_confirmation')"> Show Confirm Password
                                </label>
                            </div>
