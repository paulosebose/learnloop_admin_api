        ...
        <div class="content-wrapper">
            ...
            <div class="content-body">
                ...
                <section id="dashboard-analytics">
                    ...
                    <!-- List DataTable -->
                    <div class="container">
                        <h2 class="text-center mt-4">Edit Quiz Levels</h2>
                        @if(session('success'))
                    ...
                    @endif
                        ...
                        <div class="table-responsive">
                            <form action="{{ route('editlevel', $level->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    @if($level->image)
                                        <div class="mt-2">
                                            <p>Current Image:</p>
                                            <img src="{{ asset($level->image) }}" alt="Level Image" class="img-thumbnail" width="100">
                                        </div>
                                    @endif
                                </div>
                                 <div class="form-group">
                ...
                <select name="subject" id="subject" class="form-control" required>
                    <option value="">Select a Subject</option> <!-- Default empty option -->
                    @foreach($subjects as $subject)
                        <option value="{{ $subject->id }}" 
                            {{ old('subject', $level->subject_id) == $subject->id ? 'selected' : '' }}>
    ...
    <div>
        <label class="mr-2">
            <input type="radio" name="paid" value="1" 
                {{ old('paid', $level->paid) == 1 ? 'checked' : '' }}> Paid
        </label>
        <label>
            <input type="radio" name="paid" value="2" 
                {{ old('paid', $level->paid) == 2 ? 'checked' : '' }}> Free
        </label>
    </div>
</div>
