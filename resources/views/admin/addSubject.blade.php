        ...
        <div class="content-wrapper">
            ...
            <div class="content-body">
                ...
                <section id="dashboard-analytics">
                    ...
                    <!-- List DataTable -->
                    <div class="container">
                        <h2 class="text-center mt-4">Add Subject</h2>
                        @if(session('success'))
                        ...
                        @endif
                            ...
                            @endif
                            <form action="{{ route('insertSubject') }}" method="POST" enctype="multipart/form-data">  <!-- Update with your route -->
                            @csrf
                            <div class="form-group">
                                <label for="levelName">Subject Name</label>
                                <input type="text" class="form-control" id="levelName" name="subject_name" required>
                            </div>
                            <div class="form-group">
                            <label for="duration">Duration</label>
                            <input type="text" class="form-control" id="duration" name="duration" placeholder="Course Validity" required>
                        </div>
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                <label for="levelImage">Upload Image</label>
