        ...
        <div class="content-wrapper">
            ...
            <div class="content-body">
                ...
                <section id="dashboard-analytics">
                    ...
                    <!-- List DataTable -->
                    <div class="container">
                        <h2 class="text-center mt-4">Question Details</h2>
                        ...
                        <div class="card mt-4">
                            <div class="card-body">
                                ...
                                @if($question->image)
                                    <div class="mt-2">
                                        <p>Image:</p>
                                        <img src="{{ asset($question->image) }}" alt="Question Image" class="img-thumbnail" width="300">
                                    </div>
                                @endif
                                <h5>Reason:</h5>
<p>{{ $question->reason }}</p>
                                ...
                                <ul class="list-group">
                                    @foreach($question->options as $option)
                                        <li class="list-group-item {{ $option->is_correct ? 'list-group-item-success' : '' }}">
                                            ...
                                            @else
                                                <span class="badge bg-secondary float-end">Incorrect</span>
                                            @endif
                                        </li>
                                    @endforeach
                                </ul>
