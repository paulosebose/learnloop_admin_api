        ...
        <div class="navbar-container d-flex content">
            ...
            <ul class="nav navbar-nav align-items-center ml-auto">
                ...
                <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="user-nav d-sm-flex d-none"><span class="user-name font-weight-bolder">Admin</span></div><span class="avatar"><img class="round" src="/spartans/quizsite/public/app-assets/images/portrait/small/profile.png" alt="avatar" height="40" width="40"><span class="avatar-status-online"></span></span>
                    </a>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-body">
                ...
                <section id="dashboard-analytics">
                    ...
                    <!-- List DataTable -->
                    <div class="container">
                        <h2 class="text-center mt-4">Subjects</h2>
                        <div class="text-right mb-3">
                            <a href="{{ route('viewAddSubject')}}" class="btn btn-primary btn-sm">Add Subject</a>
                                    ...
                                    <tr>
                                       ...
                                       <!--<td>{{ $subject->id }}</td> -->
                                        ...
                                        <td>{{ $subject->amount }}</td>
                                           ...
                                           <td>
                                            @if ($subject->image)
                                            <img src="{{ $subject->image }}" alt="{{ $subject->subject_name }}" class="img-thumbnail" style="width: 50px; height: 50px;">
                                            @else
                                            <span>No Image</span>
                                            @endif
                                        ...
                                        <td>
                                             <a href="{{ route('subjects.edit', $subject->id) }}" class="btn btn-edit btn-sm">Edit</a>
